...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    estado: Schema.Attribute.Enumeration<['pending', 'approved', 'rejected']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::comment.comment'
...
export interface ApiGaleriaGaleria extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Famoso: Schema.Attribute.String;
...
export interface ApiSubscriberSubscriber extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    source: Schema.Attribute.Enumeration<
      ['newsletter', 'google-login ', 'manual', 'other']
    >;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    favorite_articles: Schema.Attribute.Relation<
      'manyToMany',
      'api::article.article'
    >;
    favorite_tags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
